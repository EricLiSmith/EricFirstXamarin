...
namespace FirstXamarin.Droid
{
	...
	public class WebActivity : Activity
	{
		...
		private Button btnGoWeb { get; set;}
		private EditText etUrl { get; set;}
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
			...
			myWebView = FindViewById<WebView>(Resource.Id.wvContent);
			//btnGoWeb = FindViewById<Button>(Resource.Id.btnGoToWeb);
			etUrl = FindViewById<EditText>(Resource.Id.etInputUrl);

			//myWebView.LoadUrl("http://google.com.tw");
			//myWebView.SetWebViewClient(new WebClient());
			myWebView.SetWebViewClient(client);


			//btnGoWeb.Click += (sender, e) => {
			//	myWebView.LoadUrl(etUrl.Text);
			//	myWebView.SetWebViewClient(new WebClient());
			//};
			...
			btnGoWeb = FindViewById<Button>(Resource.Id.btnGoToWeb);
			btnGoWeb.Click += (object sender, EventArgs e) =>
			{
